...
==========================================================================================
Purpose:
	Defines the Silver layer tables for the data warehouse.
	Drops existing tables if they exists, then recreates them with an added technical column:
...
-- =========================================
DROP TABLE EXISTS IF silver.crm_sales_details;
